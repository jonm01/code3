...
function Player(maze, c, _cellsize, onComplete, sprite = null) {
  ...
  let drawSprite = drawSpriteCircle;
  let moves = 0;
  if (sprite != null) {
...
window.onload = function () {
  ...
  sprite = new Image();
  sprite.src =
    'https://image.ibb.co/dr1HZy/Pf_RWr3_X_Imgur.png' + `?${new Date().getTime()}`;
  ...
  finishSprite.src =
    'https://image.ibb.co/b9wqnJ/i_Q7m_U25_Imgur.png' + `?${new Date().getTime()}`;
